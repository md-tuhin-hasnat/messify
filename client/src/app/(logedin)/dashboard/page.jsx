...
//     }
//     if(localStorage.getItem('MessCode')) fetchDashboardData()
//   }, [messValue])
...
//   return (
//     messCode !== null?(<div className="container mx-auto p-4 space-y-6">
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const response = await axios.get(
          `${backendURL}/api/dashboard/get-data/${messCode}/${new Date()}`,
          { withCredentials: true }
        );
